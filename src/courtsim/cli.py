...
from courtsim.analysis.artifact_inventory import ArtifactInventoryError
from courtsim.analysis.artifact_retention import ArtifactRetentionError
...
from courtsim.analysis.nba_manager_source_sync import NBAManagerSourceSyncError
from courtsim.analysis.nba_manager_state import NBAManagerStateError
...
from courtsim.cli_artifacts import (
    ARTIFACT_COMMANDS,
    register_artifact_commands,
    run_artifact_command,
)
from courtsim.cli_manager import (
    MANAGER_COMMANDS,
...
from courtsim.nba_manager_experiment import NBAManagerExperimentError
from courtsim.nba_manager_study import NBAManagerStudyError
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if arguments.command in ARTIFACT_COMMANDS:
            return run_artifact_command(arguments)
    except (
        ArtifactArchiveError,
