...
- Engine release candidate: `0.13.0`.
...
- mypy strict: passed.
- pytest: 368 passed; one Windows symlink test skipped when link privileges are absent.
...
- Draft lottery/protections, scouting uncertainty, AI trades, manager rotations and learning,
  playoff fatigue/injury continuity, human-approved promotion beyond Shadow mode,
  play-in/larger playoff formats, and fantasy-manager gameplay.
